"""blank_migration_for_missing_revision_2627f3ecc28f

Revision ID: 2627f3ecc28f
Revises: 
...
def upgrade() -> None:
    ...
    print("ℹ️  Blank migration 2627f3ecc28f - no schema changes")
...
def downgrade() -> None:
    ...
    print("ℹ️  Blank migration 2627f3ecc28f downgrade - no schema changes")
    pass
